...
@Component({
  selector: 'app-histori-pembelian-nasabah',
  templateUrl: './histori-pembelian-nasabah.component.html',
  styleUrls: ['./histori-pembelian-nasabah.component.css']
})
export class HistoriPembelianNasabahComponent implements OnInit {
  ...
  getHistoriPembelianNasabah():void{
    
    this.historiTransaksiService.getHistoriPembelianNasabah(this.bcaId).subscribe((response:any)=>{
  ...
  search(ngForm:NgForm):void{
    if(ngForm.valid)
    {
      this.getHistoriPembelianNasabah();
      this.bcaId="";
      this.loader="flex";
      this.display="hidden";
